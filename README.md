...
4. Pro Workflow
When you finish a contest, you can archive your solutions and reset your workspace in one go:
- If you did a cf contest, what I do is `mkdir .cfcontest/{id_contest} && cp *.cpp .cfcontest/{id_contest} & setup`
